...
/***/ function(module, exports, __webpack_require__) {
	...
	var getReviewElement = __webpack_require__(6);
	var getCallback = __webpack_require__(7);
	var callbackName = 'JSONPCallback';
	var CALLBACK_URL = 'http://localhost:1506/api/reviews?callback=';
	var reviews = [];
	...
	getCallback(callbackName, CALLBACK_URL, renderToPage);
...
/***/ function(module, exports) {
	...
	function getCallback(cbName, url, doSomething) {
	//Describing JSONP Callback function
	  url += cbName;
	  window[cbName] = doSomething;
	// Describing our new script
	  var scriptEl = document.createElement('script');
	// Launches HTTP request with url
	  scriptEl.src = url;
	// Creating and running our new script with JSONP Callback function
